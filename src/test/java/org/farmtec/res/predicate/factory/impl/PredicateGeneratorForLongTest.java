...
class PredicateGeneratorForLongTest {
    ...
    PredicateGenerator<Long> predicateGenerator = new PredicateGeneratorForLong();

    @Test
    void getPredicate_equals() {
        //given
        Predicate<Long> predicate = predicateGenerator.getPredicate(Operation.EQ, Long.MAX_VALUE - 2);
    ...
    void getPredicate_NotEquals() {
        //given
        Predicate<Long> predicate = predicateGenerator.getPredicate(Operation.NEQ, Long.MAX_VALUE - 2);
    ...
    void getPredicate_GreaterThan() {
        //given
        Predicate<Long> predicate = predicateGenerator.getPredicate(Operation.GT, Long.MAX_VALUE - 2);
    ...
    void getPredicate_GreaterEqualsThan() {
        //given
        Predicate<Long> predicate = predicateGenerator.getPredicate(Operation.GTE, Long.MAX_VALUE - 2);
    ...
    void getPredicate_LessThan() {
        //given
        Predicate<Long> predicate = predicateGenerator.getPredicate(Operation.LT, Long.MAX_VALUE - 2);
    ...
    void getPredicate_LessEqualsThan() {
        //given
        Predicate<Long> predicate = predicateGenerator.getPredicate(Operation.LTE, Long.MAX_VALUE - 2);
    ...
    void getPredicate_Contais_shouldBeNull() {
        //given
        Predicate<Long> predicate = predicateGenerator.getPredicate(Operation.CONTAINS, Long.MAX_VALUE - 2);
