...
class PredicateGeneratorForIntTest {
    ...
    PredicateGenerator<Integer> predicateGenerator = new PredicateGeneratorForInt();

    @Test
    void getPredicate_equals() {
        //given
        Predicate<Integer> predicate = predicateGenerator.getPredicate(Operation.EQ, 5);
    ...
    void getPredicate_NotEquals() {
        //given
        Predicate<Integer> predicate = predicateGenerator.getPredicate(Operation.NEQ, 5);
    ...
    void getPredicate_GreaterThan() {
        //given
        Predicate<Integer> predicate = predicateGenerator.getPredicate(Operation.GT, 5);
    ...
    void getPredicate_GreaterEqualsThan() {
        //given
        Predicate<Integer> predicate = predicateGenerator.getPredicate(Operation.GTE, 5);
    ...
    void getPredicate_LessThan() {
        //given
        Predicate<Integer> predicate = predicateGenerator.getPredicate(Operation.LT, 5);
    ...
    void getPredicate_LessEqualsThan() {
        //given
        Predicate<Integer> predicate = predicateGenerator.getPredicate(Operation.LTE, 5);
    ...
    void getPredicate_Contais_shouldBeNull() {
        //given
        Predicate<Integer> predicate = predicateGenerator.getPredicate(Operation.CONTAINS, 5);
